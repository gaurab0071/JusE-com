            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner bg-light">
                    ...
                    <div class="carousel-item">
                        <img class="w-100 h-100" src="{{ asset($subImage->filename) }}" alt="Image">
                    </div>
                    @endforeach
                </div>
        ...
        <div class="col-lg-7 h-auto mb-30">
            <div class="h-100 bg-light p-30">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <a href="/frontend/cart" class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i>Add To Cart</a>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="cartSuccessModalLabel">Item Added to Cart</h5>
...
<script>
    // Trigger the modal when the "Add To Cart" button is clicked
    $(document).ready(function() {
        $('a[data-target="#cartSuccessModal"]').on('click', function() {
